...
import { Search, Package, Plus, User, LayoutDashboard, LogOut, Settings } from "lucide-react";
...
const Profile = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-background via-background/95 to-background font-inter">
      ...
      {/* Main Content */}
      <main className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 pb-32 max-w-6xl min-h-screen">
