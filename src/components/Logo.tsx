...
const Logo: React.FC<LogoProps> = ({
  ...
  const logoClasses = cn('w-auto object-contain transition-all duration-300', {
  ...
  if (disableDefaultLink) {
    return <img src={logoSrc} alt="PartMatch - Car Parts Marketplace" className={logoClasses} onClick={onClick} style={{
